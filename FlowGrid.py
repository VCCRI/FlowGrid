'''
Our algorithm depends on two packages including sklearn and numpy.
It contains three steps including
1. dividing data into equal sized bins
2. grouping core bins with their neighboring bins
3. labelling the sample according to the label of bin
'''
